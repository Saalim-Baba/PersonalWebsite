...
export default function Hobbys(){
    ...
    const hobbys = [
        { name: "Hiking", description: "Genieße die Natur beim Wandern.", margin: 12 },
        { name: "Fitness", description: "Stärke deinen Körper im Gym.", margin: 32 },
        { name: "Technical", description: "Löse Probleme durch Code.", margin: 52 },
